      ...
      <section id="content-wrapper">
        ...
        <div className="row main-section " onClick={ () => this.props.onClickMain()}>
          <div className="col-lg-12">
            ...
            <div id="skills">
            {/* <h2 className=" head-offset">Skills section</h2> */}
            ...
            <div id="projects" >
            {/* <h2 className=" head-offset">Projects section</h2> */}
            ...
            <div id="education">
            {/* <h2 className=" head-offset">Education section</h2> */}
            ...
            <div id="experience">
            {/* <h2 className=" head-offset">Experience section</h2> */}
            ...
            <div id="contact">
            {/* <h2 className=" head-offset">Contact section</h2> */}
            ...
            <div id="resume">
            {/* <h2 className=" head-offset">Resume section</h2> */}
